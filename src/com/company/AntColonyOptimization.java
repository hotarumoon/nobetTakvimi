...
public class AntColonyOptimization {
    ...
    //the beta parameter should be greater than alpha for the best results.
    ...
    private double antFactor = 0.8; // how many ants we'll use per city.
    private double randomFactor = 0.01; //creates the randomness
